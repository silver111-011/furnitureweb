        ...
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
              <a class="nav-link" href="{{route('moderator')}}">
                ...
                <span class="menu">Dispute Orders</span>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('blockusers')}}" id="btnInv">
                <span class="icon" data-bs-toggle="tooltip" data-bs-title="View">
                  <i class="fas fa-cube"></i>
                </span>
                <span class="menu">Block Seller</span>
              </a>
            </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('moderatorlogout')}}">
            ...
            <div class="ms-auto d-flex align-items-center">
              ...
              <div class="dropdown">
                ...
                <a class="nav-link dropdown-toggle py-1 px-3 rounded-1" href="#" role="button" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <i class="fas fa-user-circle me-1"></i>{{$moderator->fname}}
                </a>

                <ul class="dropdown-menu dropdown-menu-end">
                  <li><a class="dropdown-item" href="{{route('moderatorlogout')}}"><i class="fa-solid fa-right-from-bracket me-2"></i>Logout</a>
                  </li>
                </ul>
              </div>
